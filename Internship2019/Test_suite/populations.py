...
AV2017_pop_query = '''SELECT
SUBSTR(multi_depr_index.QUINTILE_2015, 1, 1) AS QUINTILE_2015,
SUBSTR(at_tumour.CREG_CODE, 2) AS CREG_CODE,
TO_CHAR(at_tumour.DIAGNOSISDATEBEST, 'YYYY-MM-DD') AS DIAGNOSISDATEBEST,
TO_CHAR(at_tumour.DIAGNOSISDATEBEST, 'YYYY-MM') AS DIAGNOSISMONTHBEST,
TO_CHAR(at_tumour_exp.DATE_FIRST_SURGERY, 'YYYY-MM-DD') AS DATE_FIRST_SURGERY,
TO_CHAR(at_tumour_exp.DATE_FIRST_SURGERY, 'YYYY-MM') AS MONTH_FIRST_SURGERY,
at_tumour.AGE, at_tumour.GRADE, at_tumour.SEX,
at_tumour.SITE_ICD10_O2, at_tumour.SITE_ICD10_O2_3CHAR, at_tumour.MORPH_ICD10_O2, at_tumour.BEHAVIOUR_ICD10_O2,
at_tumour.T_BEST, at_tumour.N_BEST, at_tumour.M_BEST, at_tumour.STAGE_BEST, at_tumour.STAGE_BEST_SYSTEM,
at_tumour.SCREENINGSTATUSFULL_CODE, at_tumour.ER_STATUS, at_tumour.ER_SCORE, at_tumour.PR_STATUS, at_tumour.PR_SCORE, at_tumour.HER2_STATUS, at_tumour.LATERALITY,
at_tumour.GLEASON_PRIMARY, at_tumour.GLEASON_SECONDARY, at_tumour.GLEASON_TERTIARY, at_tumour.GLEASON_COMBINED,
at_tumour_exp.CANCERCAREPLANINTENT, at_tumour_exp.PERFORMANCESTATUS, at_tumour_exp.CNS, at_tumour_exp.ACE27
FROM
...
LEFT JOIN 
(SELECT TUMOURID, CANCERCAREPLANINTENT, PERFORMANCESTATUS_NEW AS PERFORMANCESTATUS, CNS, ACE27, DATE_FIRST_SURGERY 
...
pop_queries = {'sim1': SIM1_pop_query.replace('\n', ' '),
               'sim2': SIM2_pop_query.replace('\n', ' '),
               'av2015': AV2015_pop_query.replace('\n', ' '),
